      ...
      >
        <div className="flex flex-col items-start py-4 w-full space-y-2">
          <div className="text-sm flex flex-col items-start w-full space-y-1">
            <Link
              ...
              className={`flex space-x-2 items-center h-fit ${
                location.pathname === "/home" ? "" : "hover:bg-gray-100"
              } w-full py-2 px-2 ${
                location.pathname === "/home" ? "bg-gray-200" : "bg-transparent"
              } ${
          ...
          <div className="text-sm flex flex-col items-center w-full h-fit space-y-4">
            ...
            <div className="flex flex-col items-start justify-center w-48 px-3 space-y-1">
